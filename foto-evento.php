...
{
    //alert(cdFoto);
    $.get('adiciona-foto.php',{tipo:"evento", acao:"adiciona", cd_foto: cdFoto});
...
//list($pode_vender) = mysqli_fetch_array($rs1);

$rs1 = mysqli_query($conn, "SELECT vl_foto FROM eventos WHERE cd_evento='$cd'");
