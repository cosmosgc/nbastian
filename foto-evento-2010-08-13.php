...
if($pode_vender)
{
    echo '<strong>Voc&ecirc; pode solicitar a compra dessa foto.</strong> <br />Adicione-a ao carrinho ou clique para ver  todas as solicita&ccedil;&otilde;es j&aacute; feitas.';
}
else
{
    echo '<strong>Esta foto n�o pode ser solicitada para compra.</strong><br />Para ver todas as solicita��es j� feitas, clique no bot�o ao lado.';
}
?>
</span>
