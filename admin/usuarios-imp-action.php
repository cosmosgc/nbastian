...
if(isset($_POST['acao']) && $_POST['acao'] == "cadastra")
{
    ...
    else
    {
        ...
        $rs= mysqli_query($conn, "SELECT COUNT(*) FROM imprensa_usuarios WHERE email_usuario='$email_usuario'");
...
elseif(isset($_POST['acao']) && $_POST['acao'] == "edita")
{
    ...
    else
    {
        ...
        $rs= mysqli_query($conn, "SELECT COUNT(*) FROM imprensa_usuarios WHERE email_usuario='$email_usuario' AND cd_usuario<>'$cd'");
        list($total) = mysqli_fetch_array($rs, MYSQLI_BOTH);
