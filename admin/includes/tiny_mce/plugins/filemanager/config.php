...
//	$mcFileManagerConfig['preview.urlprefix'] = "{proto}://{host}/"; // domain name
	...
	$mcFileManagerConfig['filesystem.path'] = '../../../../../arquivos'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../../../arquivos'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,mp3,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,htm,mp3,html,pdf,txt,zip";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,mp3";
