...
//	$mcImageManagerConfig['preview.allow_export'] = "urlprefix,urlsuffix";
	$mcImageManagerConfig['preview.allow_export'] = "";
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../../arquivos'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../arquivos'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp3";
	...
	$mcImageManagerConfig['thumbnail.jpeg_quality'] = 80; // quality of th image, note that this is not checked against when regenerating ths.
	...
	$mcImageManagerConfig['upload.autoresize_jpeg_quality'] = 80; // Force max width/height, IM will rescale uploaded images.
