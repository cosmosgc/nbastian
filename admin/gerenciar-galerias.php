			...
			<div id="miolo">
				...
				<form name="form1" id="form1" method="post" action="galerias-action.php" enctype="multipart/form-data">
                    ...
                    <table>
    				    ...
    				    <tbody>
                        <?php
                        $rs = mysql_query("SELECT COUNT(*) FROM fotos_galeria WHERE cd_galeria='$codigo'");
                        ...
                        for($x=1; $x<=$total; $x++)
                        {
                            $inicial = ($x-1)*4;
                            echo '<tr>';
                            $rs1 = mysql_query("SELECT * FROM fotos_galeria WHERE cd_galeria='$codigo' ORDER BY cd_foto ASC LIMIT $inicial,4");
