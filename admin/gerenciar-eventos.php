...
<body>
	...
	<div id="geral"> <!-- geral -->
		...
		<div id="conteudo"> <!-- conteudo -->
			...
			<h5><a href="principal.php" title="Voltar para p&aacute;gina principal">&raquo;  Principal</a> &raquo; Gerenciamento de Fotos das Eventos/Exposi&ccedil;&otilde;es </h5>
			...
			<div id="miolo">
				...
				<h4>&raquo; <?php echo implode("/",array_reverse(explode("-",$var['dt_evento'])));?> <?php echo $var['nm_evento'];?></h4>
				...
				<form name="form1" id="form1" method="post" action="eventos-action.php" enctype="multipart/form-data">
                    ...
                    <input class="botaovoltar" type="submit" name="cadastrar" id="cadastrar" value="Voltar" tabindex="10" title="Voltar p&aacute;gina" onclick="location.href='cadastro-eventos.php'; return false;" />
