...
/************************************************/	
		...
		function buildPanels() {
			...
			if(!has_filmstrip || has_filmstrip) {
				//Add navigation buttons
                $('<img />').addClass('nav-next').attr('src',img_path+opts.nav_theme+'/seta+direita.png').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
				...
				$('<img />').addClass('nav-prev').attr('src',img_path+opts.nav_theme+'/seta+esquerda.png').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
					'top':((opts.panel_height-22)/2)+'px',
