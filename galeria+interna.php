	...
	<div id="geral"> <!-- in�cio div geral - engloba todo o site -->
        ...
        <div class="galeria" id="apple"> <!-- inicio div galeria -->
            ...
            <div class="box">
                ...
                ?>
            	<h4><a href="solicitacao.php" title="Visualizar carrinho de solicita��es"><img src="imagens/bt+categorias.png" /></a><span>Galeria:</span><?php echo htmlentities(strtoupper($nm_galeria));?></h4>
