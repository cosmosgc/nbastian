...
var Shadowbox = function(){
    ...
    S = {
         ...
         */
        options: {
            page: 1,                    // Custom option
            totalOfImages: 1,           // Custom option
            pageSize: 1,                // Custom option
            ...
            viewportPadding: 10         // amount of padding to maintain around the
        ...
        getCounter: function(){
            ...
            if(S.options.counterType == 'skip'){
                ...
                var c = (((S.options.page-1)*S.options.pageSize)+(S.current + 1)) + ' ' + S.lang.of + ' ' + (S.options.totalOfImages);
...
Shadowbox.skin = function(){
    ...
    return {
        ...
        markup: '<div id="sb-container">' +
                    ...
                    '<div id="sb-wrapper">' +
                        '<div id="sb-title" style="display:none;">' +
