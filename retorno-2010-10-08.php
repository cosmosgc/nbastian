...
function send_mail($to, $assunto, $corpo){
    $headers = "From: NBastian Fotografia | Comunicacao  <contato@agenciap4.com.br>\r\n";
    $headers .= "Reply-To : contato@agenciap4.com.br\r\n";
    $headers .= "Return-Path: contato@agenciap4.com.br\r\n";
